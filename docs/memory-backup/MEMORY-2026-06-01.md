...
§
服务器架构关键：shengtuo.cc.cd 网站实际运行在 54.168.228.5 (AWS)，非本机(43.155.135.188)。本机仍有 shengtuo-website 目录但只是备用。调试网站问题需 SSH 到 54.168.228.5，当前无 SSH 密钥配置。